 ...
 * @author 11638
 */
public class HRJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HRJFrame
     */
    public HRJFrame(EcoSystem system, Enterprise en, EmployeeAccount account, JPanel jpanel) {
        initComponents();
        this.system = system;
        this.en = en;
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        if (!usernameTfl.getText().equals("") || 
            ...
            this.dispose();
            manageEmployeeJPanel.populateHRTable();
