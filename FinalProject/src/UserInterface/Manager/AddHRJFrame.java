 ...
 * @author 11638
 */
public class AddHRJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AddHRJFrame
     */
    public AddHRJFrame(EcoSystem system, Enterprise enterprise, JPanel jPanel) {
        this.system = system;
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        // TODO add your handling code here:
            ...
            account = new EmployeeAccount(username, password, new HRRole(), em);
            enterprise.addEmployee(em);
            enterprise.getAccountDir().getAccountList().add (account);
            jPanel.populateHRTable();
