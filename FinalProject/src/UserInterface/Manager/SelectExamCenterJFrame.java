 ...
 * @author ranranhe
 */
public class SelectExamCenterJFrame extends javax.swing.JFrame {
     ...
     */
    public SelectExamCenterJFrame(EcoSystem system, Network network, ApplyRequest applyRequest) {
        initComponents();
        this.system = system;
        ...
        DefaultListCellRenderer renderer = (DefaultListCellRenderer) examList.getCellRenderer();
        renderer.setHorizontalAlignment(SwingConstants.CENTER);
            
        DefaultListModel<ExamEnterprise> model = new DefaultListModel<>();
        ArrayList<ExamEnterprise> list = network.getExamEnterpriseList();
        for (ExamEnterprise exam : list) {
    ...
    private void initComponents() {
        ...
        examList = new javax.swing.JList<ExamEnterprise>();
        ...
        jLabel1.setText("Select Exam Enterprise");

        examList.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (examList.getSelectedValue() != null) {
            ExamEnterprise examEnterprise = (ExamEnterprise) examList.getSelectedValue();
            examRequest = new ExamRequest(examEnterprise, applyRequest.getAccount());
            applyRequest.createExamRequest(examRequest);
...
//    }
    ...
    private javax.swing.JList<ExamEnterprise> examList;
